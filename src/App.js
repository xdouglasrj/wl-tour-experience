...
const routeMedia = {
  ...
  1: { type: "image", src: mediaFiles.panoramic },
  2: {
    type: "gallery",
    items: [
      { type: "video", src: mediaFiles.capoeiraVideo19 },
      { type: "video", src: mediaFiles.capoeiraVideo20 },
      { type: "video", src: mediaFiles.capoeiraVideo21 },
    ],
  },
  3: { type: "image", src: mediaFiles.lajeView },
  4: { type: "video", src: mediaFiles.routeAerial },
  5: {
    type: "gallery",
    items: [
      { type: "image", src: mediaFiles.graffiti6 },
      { type: "image", src: mediaFiles.graffiti15 },
      { type: "image", src: mediaFiles.graffiti16 },
    ],
  },
  6: {
    type: "gallery",
    items: [
      { type: "video", src: mediaFiles.futebolVideo14 },
      { type: "video", src: mediaFiles.futebolVideo15 },
      { type: "image", src: mediaFiles.futebolPhoto20 },
    ],
  },
  7: {
    type: "gallery",
    items: [
      { type: "video", src: mediaFiles.curvaVideo17 },
      { type: "video", src: mediaFiles.curvaVideo18 },
    ],
  },
  8: {
    type: "gallery",
    items: [
      { type: "video", src: mediaFiles.ruaVideo16 },
      { type: "video", src: mediaFiles.ruaVideo8 },
      { type: "image", src: mediaFiles.ruaPhoto17 },
      { type: "image", src: mediaFiles.ruaPhoto18 },
      { type: "image", src: mediaFiles.ruaPhoto19 },
    ],
  },
};
          ...
          <div className="social-card">
            ...
            <div className="testimonial-grid">
              {testimonials.map((testimonial, index) => (
                <figure key={index} className="testimonial-item">
                  <button
                    type="button"
                    className="testimonial-open"
                    onClick={(event) =>
                      openMedia(
